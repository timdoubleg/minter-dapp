const contractAddress = "0xD61934267A419EAA684A71D61E30346aC351Ee1C"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Grllflings NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = "The Grllflings NFT Project is a fun project for Veru's birthday";
const h1_presale_coming_soon = "NFT Drop Coming Soon!!";
const h1_presale_mint = "Pre-Sale Minting Open!!";
const h1_public_mint = "Grllflings Minting Open!!";
const h2_presale_coming_soon = "Pre-Sale Minting Countdown";
const h2_presale_mint = "Grllflings Minting Countdown";
